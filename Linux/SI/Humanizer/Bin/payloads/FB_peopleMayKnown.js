...
class FB_peopleMayKnown
{
    ...
    async debug(value) { console.dir("[FB_peopleMayKnown] ", value); }
}

fb_peopleMayKnown = new FB_peopleMayKnown();
fb_peopleMayKnown.addAllFriends().then();
